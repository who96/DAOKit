...
_CORE_ROTATION_SCENARIO_MATRIX: tuple[CoreRotationChaosScenarioFixture, ...] = (
    CoreRotationChaosScenarioFixture(
        ...
        continuity_assertions=("CONT-001", "CONT-002", "CONT-003", "CONT-004", "CONT-006", "CONT-007", "CONT-008"),
    ...
    CoreRotationChaosScenarioFixture(
        ...
        continuity_assertions=("CONT-001", "CONT-002", "CONT-003", "CONT-004", "CONT-005", "CONT-007", "CONT-008"),
