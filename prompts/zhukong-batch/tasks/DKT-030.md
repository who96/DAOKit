请进入主控模式，执行任务 DKT-030（Implement LangGraph orchestrator runtime）。
...
【任务锚点】
- Task ID: DKT-030
- Title: Implement LangGraph orchestrator runtime
...
【Allowed Scope（超出即拒绝）】
- src/orchestrator/ src/state/ tests/orchestrator/ contracts/
