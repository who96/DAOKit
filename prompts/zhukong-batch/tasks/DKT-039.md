请进入主控模式，执行任务 DKT-039（Implement first-class make release-check workflow）。
...
【任务锚点】
- Task ID: DKT-039
- Title: Implement first-class make release-check workflow
...
【Allowed Scope（超出即拒绝）】
- Makefile scripts/ src/cli/ tests/ docs/reports/
