请进入主控模式，执行任务 DKT-008（Implement function-calling adapter）。
...
【任务锚点】
- Task ID: DKT-008
- Title: Implement function-calling adapter
...
【Concrete Actions】
1) Define tool registry with JSON-schema validation
2) Add command wrappers and timeout handling
...
【Allowed Scope（超出即拒绝）】
- src/tools/function_calling/ src/tools/common/ tests/tools/
