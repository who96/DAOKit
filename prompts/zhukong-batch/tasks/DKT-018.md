请进入主控模式，执行任务 DKT-018（Open-source release package）。
...
3) Publish release tag and roadmap for v1.1 and v1.2
...
【Allowed Scope（超出即拒绝）】
- docs/ README.md CONTRIBUTING.md SECURITY.md CHANGELOG.md examples/
