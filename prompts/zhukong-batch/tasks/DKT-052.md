请进入主控模式，执行任务 DKT-052（Implement continuity assertions and long-run soak harness）。
...
【任务锚点】
- Task ID: DKT-052
- Title: Implement continuity assertions and long-run soak harness
- Dependencies: DKT-051
...
【Allowed Scope（超出即拒绝）】
- tests/e2e/ tests/reliability/ src/reliability/ src/orchestrator/ docs/reports/
