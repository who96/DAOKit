请进入主控模式，执行任务 DKT-055（Produce v1.2 final reliability evidence packet and readiness summary）。
...
【任务锚点】
- Task ID: DKT-055
- Title: Produce v1.2 final reliability evidence packet and readiness summary
- Dependencies: DKT-054

【Goal】
Deliver final reliability evidence package and go no-go decision summary for v1.2.

【Concrete Actions】
1) Generate final reliability reports logs and audit summaries
...
【Allowed Scope（超出即拒绝）】
- docs/reports/final-run/ docs/ CHANGELOG.md prompts/zhukong-batch/
