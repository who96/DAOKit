请进入主控模式，执行任务 DKT-054（Integrate reliability gates into release-check workflow）。
...
【任务锚点】
- Task ID: DKT-054
- Title: Integrate reliability gates into release-check workflow
- Dependencies: DKT-053
...
【Allowed Scope（超出即拒绝）】
- Makefile src/verification/ src/reliability/ tests/ci/ docs/workflows/ docs/reports/
