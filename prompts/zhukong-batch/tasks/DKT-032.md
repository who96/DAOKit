请进入主控模式，执行任务 DKT-032（Integrate LangChain tool orchestration layer）。
...
【任务锚点】
- Task ID: DKT-032
- Title: Integrate LangChain tool orchestration layer
...
【Allowed Scope（超出即拒绝）】
- src/tools/ src/orchestrator/ src/hooks/ src/skills/ tests/tools/ tests/orchestrator/
