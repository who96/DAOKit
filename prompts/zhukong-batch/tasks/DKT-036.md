请进入主控模式，执行任务 DKT-036（Validate long-running reliability in integrated mode）。
...
- Dependencies: DKT-035

【Goal】
Prove takeover and handoff continuity under LangGraph plus Codex integrated execution.
...
3) Validate event lease and state consistency with replay checks
...
【Allowed Scope（超出即拒绝）】
- tests/e2e/ src/reliability/ src/orchestrator/ docs/reports/ examples/cli/
