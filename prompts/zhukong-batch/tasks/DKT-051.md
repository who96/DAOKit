请进入主控模式，执行任务 DKT-051（Expand core-rotation chaos scenario matrix）。
...
【任务锚点】
- Task ID: DKT-051
- Title: Expand core-rotation chaos scenario matrix
...
【Allowed Scope（超出即拒绝）】
- tests/e2e/ tests/reliability/ src/reliability/ docs/workflows/ docs/reports/
