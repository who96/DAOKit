请进入主控模式，执行任务 DKT-034（Implement Codex worker shim integration contract）。
...
【任务锚点】
- Task ID: DKT-034
- Title: Implement Codex worker shim integration contract
- Dependencies: DKT-029
...
【Allowed Scope（超出即拒绝）】
- src/dispatch/ src/orchestrator/ src/contracts/ tests/dispatch/ tests/orchestrator/
