请进入主控模式，执行任务 DKT-035（Add engine rollout controls and rollback runbook implementation）。
...
【任务锚点】
- Task ID: DKT-035
- Title: Add engine rollout controls and rollback runbook implementation
- Dependencies: DKT-031, DKT-033, DKT-034

【Goal】
Enable safe rollout between legacy and LangGraph LangChain integrated modes.

【Concrete Actions】
1) Add engine selector control via non-breaking config or env path
...
【Allowed Scope（超出即拒绝）】
- src/orchestrator/ src/cli/ contracts/ tests/cli/ tests/contracts/ docs/
