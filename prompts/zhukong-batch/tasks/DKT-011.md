请进入主控模式，执行任务 DKT-011（Build RAG ingestion pipeline）。
...
【任务锚点】
- Task ID: DKT-011
- Title: Build RAG ingestion pipeline
...
3) Tag chunks with source type and task and run lineage

【Acceptance Criteria】
1) New documents indexed and searchable
2) Retrieval can filter by task_id and run_id
3) Index rebuild deterministic and documented

【Allowed Scope（超出即拒绝）】
- src/rag/ingest/ src/rag/index/ tests/rag/

【Verification Baseline】
- make test-rag-ingest
