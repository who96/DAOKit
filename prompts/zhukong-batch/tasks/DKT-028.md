请进入主控模式，执行任务 DKT-028（Freeze integration architecture and compatibility contracts）。
...
【任务锚点】
- Task ID: DKT-028
- Title: Freeze integration architecture and compatibility contracts
- Dependencies: DKT-027
...
【Allowed Scope（超出即拒绝）】
- specs/003-langchain-langgraph-rag-codex-integration/ docs/ tests/cli/ tests/contracts/
