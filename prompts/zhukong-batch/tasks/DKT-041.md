请进入主控模式，执行任务 DKT-041（Harden CLI evidence bundle generation and re-verification UX）。
...
【任务锚点】
- Task ID: DKT-041
- Title: Harden CLI evidence bundle generation and re-verification UX
- Dependencies: DKT-039, DKT-040
...
【Allowed Scope（超出即拒绝）】
- src/cli/ src/reports/ tests/cli/ tests/reports/ docs/ docs/reports/
