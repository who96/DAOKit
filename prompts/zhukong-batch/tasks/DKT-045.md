请进入主控模式，执行任务 DKT-045（Integrate v1.1 hardening gates into CI and operator runbooks）。
...
【任务锚点】
- Task ID: DKT-045
- Title: Integrate v1.1 hardening gates into CI and operator runbooks
- Dependencies: DKT-042, DKT-043, DKT-044
...
【Allowed Scope（超出即拒绝）】
- .github/workflows/ Makefile docs/ src/verification/ tests/ci/
